    ...
    return(
        <HStack zIndex={2} bg={'white'} px={'1rem'} py={'10px'} w={'full'} justifyContent={'center'} position={'sticky'} top={0}>
            <HStack w={'full'} maxW={'1327px'} justifyContent={'space-between'} alignItems={'center'}>
                ...
                <Box py={2} onMouseLeave={()=>setShowDropdown(false)}>
                    <Button zIndex={2} onClick={()=>{
                        setShowDropdown(!showDropdown)
                    }} variant={'none'} type="button"py={'20px'} px={'28px'} bg={'#E72F3E'} color={'white'} lineHeight={'24px'} fontSize={'16px'} fontWeight={'600'} rounded={'full'} border={'1px solid #E72F3E'} _hover={{bg:{'md':'white'},color:'#E72F3E'}}>
                    ...
                    <motion.div 
                    initial={{opacity:0,y:'-40px',visibility:'hidden'}}
                    style={{position:'relative'}} animate={{
                        y:showDropdown ? '-40px' : '-100px',
                    ...
                    >
                        <VStack
                            ...
                            border={'1px solid #0000001A'} zIndex={-1} top={'3rem'} right={'-1rem'} bg={'white'} position={'absolute'} shadow={'xl'} w={'full'} minW={'12rem'} maxW={'246px'} rounded={'lg'} gap={0}
                        >
                            <Stack
                            ps={"0.85rem"}
                            pe={"0.5rem"}
                                ...
                                <HStack justifyContent={'end'} alignItems={'center'} gap={'0.75rem'} mr={'0.85rem'}>
                                    <Button fontSize={'12px'}
                                        ...
                                        onClick={() => {
                                            ...
                                            "https://github.com/vinaysingh8866/bwn-landing-page/raw/refs/heads/main/public/installers/bharat-webnavigator-stable-128.0.6572.0-1.x86_64.rpm?download=";
                                        }}
                                        >
                                        .rpm
                                        <Image src="/download.svg" h={"16px"} />
                                    ...
                                    <Button fontSize={'12px'}
                                        ...
                                        onClick={() => {
                                            window.location.href =
                                            "https://github.com/vinaysingh8866/bwn-landing-page/raw/refs/heads/main/public/installers/bharat-webnavigator-stable_128.0.6572.0-1_amd64.deb?download=";
                                        }}
                                        >
                                        .deb
                                        <Image src="/download.svg" h={"16px"} />
                            ...
                            >
                                ...
                                onClick={() => {
                                    ...
                                    window.location.href = "https://github.com/vinaysingh8866/bwn-landing-page/raw/refs/heads/main/public/installers/BWN.dmg?download=";
                                }}
                                >
                                <Image src="/download.svg" h={"16px"} />
                                </Button>
